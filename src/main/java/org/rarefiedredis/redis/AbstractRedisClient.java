...
public abstract class AbstractRedisClient implements IRedisClient {
    ...
    @Override public Long zadd(String key, double score, String member, Object ... scoresmembers) throws WrongTypeException, NotImplementedException, SyntaxErrorException, NotFloatException {
        throw new NotImplementedException();
    }
    ...
    @Override public Long zinterstore(String destination, int numkeys, String ... options) throws WrongTypeException, SyntaxErrorException, NotImplementedException {
        throw new NotImplementedException();
    }
    ...
    @Override public Set<ZsetPair> zrevrangebylex(String key, String max, String min, String ... options) throws WrongTypeException, NotValidStringRangeItemException, NotImplementedException {
        throw new NotImplementedException();
    }
    ...
    @Override public Set<ZsetPair> zrevrangebyscore(String key, String max, String min, String ... options) throws WrongTypeException, NotFloatMinMaxException, NotIntegerException, SyntaxErrorException, NotImplementedException {
        throw new NotImplementedException();
    }

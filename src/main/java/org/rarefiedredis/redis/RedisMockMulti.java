...
public final class RedisMockMulti extends AbstractRedisMock {
    ...
    @Override
    public Long bitcount(final String key, long... options) {
    ...
    @Override
    public String incrbyfloat(final String key, final double increment) {
    ...
    @Override
    public String set(final String key, final String value, String... options) {
    ...
    @Override
    public Long lpush(final String key, final String element, final String... elements) {
        return (Long) command("lpush", key, element, elements);
    }

    @Override
    public Long lpushx(final String key, final String element) {
    ...
    @Override
    public Long lrem(final String key, final long count, final String element) {
        return (Long) command("lrem", key, count, element);
    }

    @Override
    public String lset(final String key, final long index, final String element) {
    ...
    @Override
    public String rpoplpush(final String source, final String dest) {
        return (String) command("rpoplpush", source, dest);
    }

    @Override
    public Long rpush(final String key, final String element, final String... elements) {
        return (Long) command("rpush", key, element, elements);
    }

    @Override
    public Long rpushx(final String key, final String element) {
        return (Long) command("rpushx", key, element);
    }

    @Override
    public Long sadd(final String key, final String member, final String... members) {
    ...
    public Set<String> spop(String key, long count) {
        return (Set<String>) command("spop", key, count);
    }

    @Override
    public Set<String> srandmember(String key, long count) {
        return (Set<String>) command("srandmember", key, count);
    }
    ...
    public void hmset(String key, String field, String value, String... fieldsvalues) throws WrongTypeException, ArgException {
        command("hmset", key, field, value, fieldsvalues);
    }

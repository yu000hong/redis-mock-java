...
public final class RedisMockClient extends AbstractRedisMock {
    ...
    @Override
    public Long bitcount(final String key, long... options) throws WrongTypeException {
    ...
    @Override
    public String getrange(final String key, long start, long end) throws WrongTypeException {
    ...
    @Override
    public String set(final String key, final String value, String... options) throws SyntaxErrorException {
        return redisMock.set(key, value, options);
    }

    @Override
    public Long setbit(final String key, final long offset, final boolean value) throws WrongTypeException {
    ...
    @Override
    public String lindex(final String key, long index) throws WrongTypeException {
    ...
    public Set<String> spop(String key, long count) throws WrongTypeException {
        return redisMock.spop(key, count);
    }
    ...
    @Override
    public void hmset(String key, String field, String value, String... fieldsvalues) throws WrongTypeException, ArgException {
        redisMock.hmset(key, field, value, fieldsvalues);
    }
